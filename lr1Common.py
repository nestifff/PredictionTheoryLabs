...
def showLr1_1():
    ...
    simpleStep3 = lr1_1.simpleSmoothingOdd(series=startSeries, step=3)
    simpleStep5 = lr1_1.simpleSmoothingOdd(series=startSeries, step=5)
    simpleStep7 = lr1_1.simpleSmoothingOdd(series=startSeries, step=7)

    seriesDelete13 = startSeries
    seriesDelete13.pop()
    simpleStep4 = lr1_1.simpleSmoothingEven(seriesDelete13, step=4)

    polynomial5Degree = lr1_1.polynomial5DegreeSmoothing(startSeries)
...
def showLr1_2():
    ...
    parabolicTrend = lr1_1.getParabolicTrend()
    resultTrend = normalSeries + parabolicTrend

    resultTrendOddLength = list(resultTrend.copy())
    resultTrendOddLength.pop()
    resultTrendSmooth3 = lr1_1.simpleSmoothingOdd(resultTrendOddLength, 3)
    resultTrendSmooth9 = lr1_1.simpleSmoothingOdd(resultTrendOddLength, 9)
    resultTrendSmooth12 = lr1_1.simpleSmoothingEven(resultTrend, 12)
